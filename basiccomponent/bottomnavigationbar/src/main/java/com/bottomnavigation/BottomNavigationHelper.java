...
class BottomNavigationHelper {
     ...
     */
    private static void setBadgeForTab(com.bottomnavigation.BadgeItem badgeItem, BottomNavigationTab bottomNavigationTab) {
        if (badgeItem != null) {
    ...
    static GradientDrawable getBadgeDrawable(com.bottomnavigation.BadgeItem badgeItem, Context context) {
