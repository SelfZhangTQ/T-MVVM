...
//    }
    ...
    @CheckResult
    public @NonNull
    <T> com.trecyclerview.multitype.OneToManyFlow<T> register(@NonNull Class<? extends T> clazz) {
        checkNotNull(clazz);
        checkAndRemoveAllTypesIfNeeded(clazz);
     ...
     * @see #register(Class)
     */
    public void registerAll(@NonNull final com.trecyclerview.multitype.TypePool pool) {
        checkNotNull(pool);
     ...
     */
    public void setTypePool(@NonNull com.trecyclerview.multitype.TypePool typePool) {
     ...
     */
    @SuppressWarnings("unchecked")
    private void registerWithoutChecking(@NonNull Class clazz, @NonNull AbsItemView binder, @NonNull com.trecyclerview.multitype.Linker linker) {
        checkAndRemoveAllTypesIfNeeded(clazz);
