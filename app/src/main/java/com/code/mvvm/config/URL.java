...
/**
 * @author：zhangtianqiu on 18/5/7 15:20
 */
public class URL {
    ...
    public static final String GET_MATERIAL_LIST_NEW = "/v1_3/material/getnew";
    public static final String GET_MATERIAL_LIST_OLD = "/v1_3/material/getold";
    ...
    public static final String LESSON_DETAILS_DATA = "/v3/course/get_info";
    public static final String LESSON_DETAILS_ABOUT_DATA = "/v3_0_4/course/related";
    public static final String LIVE_DETAILS_DATA = "/v3/live/get_info";
    public static final String COURSE_TYPE = "/v3/course/catalog";
    public static final String REMMEND_COURSE = "/v3/course/recommend";
    public static final String COURSE_LIST = "/v3/course/list";
    public static final String GET_ZHIBO_LIST = "/v3/live/list";
    ...
    public static final String MATRIAL_SUBJECT_LIST = "/v3_0_2/material/get_material_subject";
    public static final String QA_LSIT = "/v3_0_2/qa/list";
    public static final String LIVING_TYPE = "/v3_0_4/live/get_live_category";
    public static final String GET_LIVING_LIST = "/v3_0_4/live/list";
    public static final String GET_FOLLOW_LIST = "/v3_0_4/lesson/list";
    public static final String GET_FOLLOW_RECOMMEND = "/v3_0_4/lesson/catalog_list_recommend";
