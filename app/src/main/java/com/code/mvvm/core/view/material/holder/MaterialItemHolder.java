 ...
 */
public class MaterialItemHolder extends AbsItemHolder<MatreialSubjectVo, MaterialItemHolder.ViewHolder> {
    private int commonWidth;

    public MaterialItemHolder(Context context) {
        super(context);
    ...
    protected void onBindViewHolder(@NonNull ViewHolder holder, @NonNull MatreialSubjectVo matreialsubject) {
        ...
        Glide.with(mContext)
                .load(matreialsubject.picurl.l.url)
