 ...
 */
public class CorrectPicViewBinder extends AbsItemView<WorkDetailVo, CorrectPicViewBinder.ViewHolder> {
    ...
    @Override
    protected void onBindViewHolder(@NonNull CorrectPicViewBinder.ViewHolder holder, @NonNull WorkDetailVo object) {
